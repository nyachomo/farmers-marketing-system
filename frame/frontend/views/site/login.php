    ...
    <div class="row">
        ...
        <div class="col-sm-4">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="background-color:#009933;color:white;"><center><h3>User Sign in<h3></center></div>
                    <div class="panel-body">
                               ...
                               <?= Html::a('Forgot password?',['user/email'],['class'=>'btn btn-link'])?>
                            <?php ActiveForm::end(); ?>
