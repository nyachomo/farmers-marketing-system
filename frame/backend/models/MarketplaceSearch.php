...
class MarketplaceSearch extends Marketplace
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['product', 'quantity', 'unit', 'price','from','to', 'name', 'email', 'phone', 'foto', 'description', 'location','negotiate', 'date', 'buyer_name', 'phone_email', 'order_date', 'buyer_phone', 'quantity_bought', 'sort'], 'safe'],
        ];
    }
